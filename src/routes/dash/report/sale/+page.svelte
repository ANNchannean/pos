			...
			<div class="col-auto">
				<div class="form-control">
					<div class="form-check py-0 my-0">
						<input
							onchange={() => {
								if (page.url.searchParams.get('status') === 'paid') {
							...
							id="debt"
						/>
						<label class="form-check-label" for="debt"> ជំពាក់ </label>
					</div>
				</div>
			</div>
			<div class="col-auto">
				<div class="form-control">
					<div class="form-check py-0 my-0">
						<input
							onchange={() => {
								if (page.url.searchParams.get('status') === 'debt') {
									document.getElementById('debt')?.click();
								}
							}}
							name="status"
							class="form-check-input"
							...
							id="paid"
						/>
						<label class="form-check-label" for="paid"> មិនជំពាក់ </label>
					</div>
				</div>
			</div>
		</HeaderQuery>
						...
						<div class="row g-0">
							<div class="col-2">
								<a
									...
									href="/dash/pos?invoice_id={invoice.id}"
