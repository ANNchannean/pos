...
(() => {
	...
	var t = {
		...
		o = [
			...
			.concat(c.map((t) => ''.concat(t, 'x')))
			.concat(s.map((t) => 'w-'.concat(t))),
	...
	(s = b({}, t))[l] = b(b(b(b({}, { 'fa-duotone': 'duotone' }), t[l]), n), r);
	let ct = d(s),
		ut =
			(((t = b(
				{},
			...
			))[l] = b(b(b(b({}, { duotone: 'fad' }), t[l]), J), i)),
			d(t)),
		dt = (((n = b({}, Z))[l] = b(b({}, n[l]), { fak: 'fa-kit' })), d(n)),
		mt =
			(((r = b(
				{},
				{
		...
		h =
			...
			m.familyPrefix && (m.cssPrefix = m.familyPrefix),
			b(b({}, s), m)),
		...
		yt =
			...
			[]),
		p = tt,
		v = { size: 16, x: 0, y: 0, rotate: 0, flipX: !1, flipY: !1 },
	...
	function At(t) {
		return (
			t.size !== v.size || t.x !== v.x || t.y !== v.y || t.rotate !== v.rotate || t.flipX || t.flipY
		);
	}
	function Pt() {
		var t,
	...
	function Nt() {
		if (x.autoAddCss && !Ot) {
			...
			if (a && f) {
				...
				let t = null;
				for (let e = n.length - 1; -1 < e; e--) {
					var i = n[e],
						o = (i.tagName || '').toUpperCase();
					-1 < ['STYLE', 'LINK'].indexOf(o) && (t = i);
				}
				g.head.insertBefore(r, t);
			}
			Ot = !0;
		}
	}
	var J = {
			mixout() {
				return { dom: { css: Pt, insertCss: Nt } };
			},
			hooks() {
				return {
		...
		return 'string' == typeof t
			...
			: '<'
					...
					.concat(
						((a = r),
						Object.keys(a || {})
							.reduce((t, e) => t + ''.concat(e, '="').concat(wt(a[e]), '" '), '')
							.trim()),
						'>'
					)
					.concat(n.map(O).join(''), '</')
	...
	f &&
		!(Et = (g.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(g.readyState)) &&
		g.addEventListener('DOMContentLoaded', St);
	var It = function (n, i) {
	...
	function Rt(t, e, a) {
		var { skipHooks: r = !1 } = 2 < arguments.length && void 0 !== a ? a : {},
			n = Dt(e);
		'function' != typeof P.hooks.addPack || r
			? (P.styles[t] = b(b({}, P.styles[t] || {}), n))
			: P.hooks.addPack(t, Dt(e)),
			'fas' === t && Rt('fa', e);
	}
	let { styles: N, shims: Lt } = P,
		Tt = Object.keys(dt),
		Yt = Tt.reduce((t, e) => ((t[e] = Object.keys(dt[e])), t), {}),
		S = null,
		Wt = {},
		Ht = {},
		_t = {},
	...
	let C = () => {
		var t = (r) => zt(N, (t, e, a) => ((t[a] = zt(e, r, {})), t), {});
		(Wt = t(
			(e, t, a) => (
				t[3] && (e[t[3]] = a),
				t[2] &&
		...
		t = zt(
			...
			(t, e) => {
				...
				return (
					'far' !== r || i || (r = 'fas'),
					'string' == typeof a && (t.names[a] = { prefix: r, iconName: n }),
					'number' == typeof a && (t.unicodes[a.toString(16)] = { prefix: r, iconName: n }),
					t
				);
			},
			{ names: {}, unicodes: {} }
		);
		(_t = t.names), (Ut = t.unicodes), (S = Kt(x.styleDefault, { family: x.familyDefault }));
	};
	function qt(t, e) {
		return (Wt[t] || {})[e];
	}
	...
	(ta = (t) => {
		S = Kt(t.styleDefault, { family: x.familyDefault });
	}),
		yt.push(ta),
		C();
	let Gt = () => ({ prefix: null, iconName: null, rest: [] });
	function Kt(t, e) {
		var { family: a = l } = 1 < arguments.length && void 0 !== e ? e : {},
			r = ct[a][t];
		return a !== u || t
			? ((a = ut[a][t] || ut[a][r]), (r = t in P.styles ? t : null), a || r || null)
			: 'fad';
	}
	function Jt(t) {
	...
	function Qt(t, e) {
		var { skipLookups: a = !1 } = 1 < arguments.length && void 0 !== e ? e : {};
		let r = null,
			n = $.concat(Q);
		var i = Jt(t.filter((t) => n.includes(t))),
			o = Jt(t.filter((t) => !$.includes(t))),
			[s = null] = i.filter((t) => ((r = t), !X.includes(t))),
			i = ((t) => {
				let a = l,
					r = Tt.reduce((t, e) => ((t[e] = ''.concat(x.cssPrefix, '-').concat(e)), t), {});
				return (
					q.forEach((e) => {
						(t.includes(r[e]) || t.some((t) => Yt[e].includes(t))) && (a = e);
					}),
					a
				);
			})(i),
			...
			b(
				...
				((t) => {
					...
					return (
						...
						!r.prefix &&
							Zt.includes(a) &&
							(Object.keys(i).find((t) => $t.includes(t)) || o.autoFetchSvg) &&
							((s = V.get(a).defaultShortPrefixId),
							(r.prefix = s),
							(r.iconName = E(r.prefix, r.iconName) || r.iconName)),
						('fa' !== r.prefix && 'fa' !== n) || (r.prefix = S || 'fas'),
						r
					);
				})({ values: t, family: i, styles: N, config: x, canonical: o, givenPrefix: r })
			),
			((t, e, a) => {
				...
				return (
					!t &&
						...
						(o = E(r, n)),
						(n = i.iconName || o || n),
						'far' !== (r = i.prefix || r) || N.far || !N.fas || x.autoFetchSvg || (r = 'fas')),
					{ prefix: r, iconName: n }
				);
			})(a, r, o)
		);
	}
	let Zt = q.filter((t) => t !== l || t !== u),
		$t = Object.keys(Z)
			.filter((t) => t !== l)
		...
		ee = Object.keys(j);
	function ae(t, e) {
		for (var a = arguments.length, r = new Array(2 < a ? a - 2 : 0), n = 2; n < a; n++)
			r[n - 2] = arguments[n];
		return (
			(M[t] || []).forEach((t) => {
				e = t.apply(null, [e, ...r]);
	...
	let ne = new (class {
			...
			add() {
				...
				Object.keys(r).forEach((t) => {
					(this.definitions[t] = b(b({}, this.definitions[t] || {}), r[t])), Rt(t, r[t]);
					var e = dt[l][t];
					e && Rt(e, r[t]), C();
				});
			}
			...
			_pullDefinitions(i, t) {
				let o = t.prefix && t.iconName && t.icon ? { 0: t } : t;
				return (
					Object.keys(o).map((t) => {
						let { prefix: e, iconName: a, icon: r } = o[t];
						var n = r[2];
						i[e] || (i[e] = {}),
							0 < n.length &&
								n.forEach((t) => {
			...
			dom: {
				...
				watch: function () {
					...
					!1 === x.autoReplaceSvg && (x.autoReplaceSvg = !0),
						...
						Mt(() => {
							F({ autoReplaceSvgRoot: e }), z('watch', t);
						});
				}
			},
			parse: {
				icon: (t) => {
					...
					return null === t
						...
						: 'object' == typeof t && t.prefix && t.iconName
							? { prefix: t.prefix, iconName: E(t.prefix, t.iconName) || t.iconName }
							: Array.isArray(t) && 2 === t.length
								? ((e = 0 === t[1].indexOf('fa-') ? t[1].slice(3) : t[1]),
									{ prefix: (a = Kt(t[0])), iconName: E(a, e) || e })
								: 'string' == typeof t &&
									  (-1 < t.indexOf(''.concat(x.cssPrefix, '-')) || t.match(mt))
									? {
											prefix: (a = Qt(t.split(' '), { skipLookups: !0 })).prefix || S,
											iconName: E(a.prefix, a.iconName) || a.iconName
										}
									: 'string' == typeof t
										? { prefix: S, iconName: E(S, t) || t }
										: void 0;
				}
			},
			library: ne,
		...
		F = function () {
			...
			(0 < Object.keys(P.styles).length || x.autoFetchSvg) &&
				f &&
				x.autoReplaceSvg &&
				ie.dom.i2svg({ node: t });
		};
	...
	function se(t) {
		...
		var d,
			m,
			{ width: h, height: p } = a.found ? a : e,
			g = K.includes(r),
			v = [x.replacementClass, n ? ''.concat(x.cssPrefix, '-').concat(n) : '']
			...
			g =
				g && !~c.classes.indexOf('fa-fw') ? { width: ''.concat((h / p) * 16 * 0.0625, 'em') } : {},
			h =
				(u && (v.attributes[y] = ''),
				s &&
					(v.children.push({
						tag: 'title',
						attributes: { id: v.attributes['aria-labelledby'] || 'title-'.concat(f || k()) },
						children: [s]
					}),
			...
			{ children: p, attributes: v } =
				a.found && e.found
					? I('generateAbstractMask', h) || { children: [], attributes: {} }
					: I('generateAbstractIcon', h) || { children: [], attributes: {} };
		return (
			(h.children = p),
			(h.attributes = v),
			o
				? (({ prefix: g, iconName: p, children: v, attributes: m, symbol: d } = h),
					(g = !0 === d ? ''.concat(g, '-').concat(x.cssPrefix, '-').concat(p) : d),
					[
						{
							tag: 'svg',
							attributes: { style: 'display: none;' },
							children: [{ tag: 'symbol', attributes: b(b({}, m), {}, { id: g }), children: v }]
						}
					])
				: (({ children: p, main: d, mask: m, attributes: g, styles: v, transform: h } = h),
					At(h) &&
						d.found &&
						!m.found &&
						(({ width: m, height: d } = d),
					...
					[{ tag: 'svg', attributes: g, children: p }])
		);
	}
	function le(t) {
		var {
			...
			l = b(b(b({}, o.attributes), i ? { title: i } : {}), {}, { class: o.classes.join(' ') }),
			s = (s && (l[y] = ''), b({}, o.styles)),
			o =
				(At(n) &&
					((s.transform = ((t) => {
						var { transform: e, width: a = tt, height: r = tt, startCentered: n = !1 } = t;
						let i = '';
						return (
							n && B
								? (i += 'translate('
								...
								: (i += n
										? 'translate(calc(-50% + '
												.concat(e.x / p, 'em), calc(-50% + ')
												.concat(e.y / p, 'em)) ')
										: 'translate('.concat(e.x / p, 'em, ').concat(e.y / p, 'em) ')),
							(i =
								(i += 'scale('
									.concat((e.size / p) * (e.flipX ? -1 : 1), ', ')
									.concat((e.size / p) * (e.flipY ? -1 : 1), ') ')) +
								'rotate('.concat(e.rotate, 'deg) '))
						);
					})({ transform: n, startCentered: !0, width: a, height: r })),
					(s['-webkit-transform'] = s.transform)),
				A(s)),
			n = (0 < o.length && (l.style = o), []);
		return (
			n.push({ tag: 'span', attributes: l, children: [e] }),
			i && n.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [i] }),
			n
		);
	}
	let fe = P.styles;
	function ce(t) {
		...
		return {
			...
			icon: (n = Array.isArray(r)
				? {
						tag: 'g',
						attributes: { class: ''.concat(x.cssPrefix, '-').concat(vt.GROUP) },
						children: [
							{
								tag: 'path',
								attributes: {
	...
	let ue = { found: !1, width: 512, height: 512 };
	function de(i, o) {
		let s = o;
		return (
			'fa' === o && null !== x.styleDefault && (o = S),
			new Promise((t, e) => {
				var a, r, n;
				if (
					('fa' === s && ((a = Vt(i) || {}), (i = a.iconName || i), (o = a.prefix || o)),
					i && o && fe[o] && fe[o][i])
				)
					return t(ce(fe[o][i]));
				(r = i),
					...
					ft ||
						...
						!r ||
						console.error(
							'Icon with name "'.concat(r, '" and prefix "').concat(n, '" is missing.')
						),
					t(
						b(b({}, ue), {}, { icon: (x.showMissingIcons && i && I('missingIconAbstract')) || {} })
					);
			})
		);
	}
	t = () => {};
	let me = x.measurePerformance && a && a.mark && a.measure ? a : { mark: t, measure: t },
		D = 'FA "6.7.2"',
		he = (t) => {
			me.mark(''.concat(D, ' ').concat(t, ' ends')),
				me.measure(
					''.concat(D, ' ').concat(t),
					''.concat(D, ' ').concat(t, ' begins'),
					''.concat(D, ' ').concat(t, ' ends')
				);
		};
	var pe = {
	...
	let ye = {
		replace: function (t) {
			...
			e.parentNode &&
				...
				null === e.getAttribute(y) && x.keepOriginalSource
					? ((a = g.createComment(
							((t = e),
							(a = ' '.concat(t.outerHTML, ' ')),
							''.concat(a, 'Font Awesome fontawesome.com '))
						)),
		...
		nest: function (t) {
			...
			let r = new RegExp(''.concat(x.cssPrefix, '-.*'));
			delete a[0].attributes.id,
				a[0].attributes.class &&
					((n = a[0].attributes.class
						.split(' ')
						.reduce(
							(t, e) => ((e === x.replacementClass || e.match(r) ? t.toSvg : t.toNode).push(e), t),
							{ toNode: [], toSvg: [] }
						)),
					(a[0].attributes.class = n.toSvg.join(' ')),
					0 === n.toNode.length
						? e.removeAttribute('class')
						: e.setAttribute('class', n.toNode.join(' ')));
			var n = a.map((t) => O(t)).join('\n');
	...
	function Ne(t) {
		...
		(Oe = new _((t) => {
			if (!we) {
				...
				w(t).forEach((t) => {
					...
					'childList' === t.type &&
						...
						!ve(t.addedNodes[0]) &&
						(x.searchPseudoElements && s(t.target), i(t.target)),
						'attributes' === t.type &&
							t.target.parentNode &&
						...
						'attributes' === t.type &&
							ve(t.target) &&
							~gt.indexOf(t.attributeName) &&
							('class' === t.attributeName &&
							((e = t.target),
							(a = e.getAttribute ? e.getAttribute(nt) : null),
							(r = e.getAttribute ? e.getAttribute(it) : null),
							a) &&
							r
								? (({ prefix: a, iconName: r } = Qt(kt(t.target))),
									t.target.setAttribute(nt, a || n),
									r && t.target.setAttribute(it, r))
								: (e = t.target) &&
									e.classList &&
			...
			f && Oe.observe(e, { childList: !0, attributes: !0, characterData: !0, subtree: !0 });
	}
	function Se(t) {
		var e,
			a,
		...
		return (
			o.prefix || (o.prefix = S),
			r && n && ((o.prefix = r), (o.iconName = n)),
			(o.iconName && o.prefix) ||
				(o.prefix &&
					0 < i.length &&
					(o.iconName =
						((e = o.prefix), (a = t.innerText), (Ht[e] || {})[a] || qt(o.prefix, Ft(t.innerText)))),
				!o.iconName &&
					x.autoFetchSvg &&
					t.firstChild &&
	...
	function Ce(t, e) {
		var a = 1 < arguments.length && void 0 !== e ? e : { styleParser: !0 },
			{ iconName: r, prefix: n, rest: i } = Se(t),
			o =
				((l = w((e = t).attributes).reduce(
				...
				x.autoA11y &&
					(o
						? (l['aria-labelledby'] = ''.concat(x.replacementClass, '-title-').concat(s || k()))
	...
	let Ee = P.styles;
	function Me(t) {
		var e = 'nest' === x.autoReplaceSvg ? Ce(t, { styleParser: !1 }) : Ce(t);
		return ~e.extra.classes.indexOf(ht)
			? I('generateLayersText', t, e)
			: I('generateSvgReplacementMutation', t, e);
	}
	function je(t) {
		let r = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : null;
		if (!f) return Promise.resolve();
		let e = g.documentElement.classList,
			n = (t) => e.add(''.concat(ot, '-').concat(t)),
			i = (t) => e.remove(''.concat(ot, '-').concat(t));
		var a = x.autoFetchSvg ? [...G, ...$] : X.concat(Object.keys(Ee)),
			a =
				(a.includes('fa') || a.push('fa'),
				['.'.concat(ht, ':not([').concat(y, '])')]
					.concat(a.map((t) => '.'.concat(t, ':not([').concat(y, '])')))
					.join(', '));
	...
	function Ie(r) {
		...
		if (r) {
			...
			return oe(
				b({ type: 'icon' }, r),
				() => (
					z('beforeDOMElementCreation', { iconDefinition: r, params: n }),
					x.autoA11y &&
						(f
							? (d['aria-labelledby'] = ''.concat(x.replacementClass, '-title-').concat(c || k()))
							: ((d['aria-hidden'] = 'true'), (d.focusable = 'false'))),
					se({
						icons: {
							main: ce(a),
							mask: s ? ce(s.icon) : { found: !1, width: null, height: null, icon: {} }
						},
						prefix: t,
						iconName: e,
						transform: b(b({}, v), i),
	...
	let Fe = {
				...
				return {
					icon:
						...
						function (t) {
							...
							let r = e.mask;
							return (
								(r = r && ((r || {}).icon ? r : re(r || {}))), n(a, b(b({}, e), {}, { mask: r }))
							);
						})
				};
				var n;
			...
			provides(t) {
				(t.i2svg = function (t) {
					...
					(t.generateAbstractIcon = function (t) {
						var { children: e, attributes: a, main: r, transform: n, styles: i } = t,
							i = A(i);
				...
				return {
					layer(t) {
						let a = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
							{ classes: r = [] } = a;
						return oe({ type: 'layer' }, () => {
							z('beforeDOMElementCreation', { assembler: t, params: a });
							let e = [];
							return (
								t((t) => {
									Array.isArray(t)
								...
								[
									{
										tag: 'span',
										attributes: { class: [''.concat(x.cssPrefix, '-layers'), ...r].join(' ') },
										children: e
									}
								]
							);
				...
				return {
					counter(n) {
						let i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
							{ title: o = null, classes: s = [], attributes: l = {}, styles: f = {} } = i;
						return oe({ type: 'counter', content: n }, () => {
							z('beforeDOMElementCreation', { content: n, params: i });
							var {
									content: t,
									title: e,
									extra: a
								...
								r = b(
									b(b({}, a.attributes), e ? { title: e } : {}),
									{},
									{ class: a.classes.join(' ') }
								);
							return (
								0 < (a = A(a.styles)).length && (r.style = a),
								(a = []).push({ tag: 'span', attributes: r, children: [t] }),
								e && a.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [e] }),
								a
							);
						});
					}
				...
				return {
					text(t) {
						...
						return oe(
							{ type: 'text', content: t },
							() => (
								z('beforeDOMElementCreation', { content: t, params: e }),
								le({
									content: t,
									transform: b(b({}, v), a),
									title: r,
									extra: {
										attributes: i,
										styles: o,
										classes: [''.concat(x.cssPrefix, '-layers-text'), ...n]
									}
								})
							)
						);
				...
				t.generateLayersText = function (t, e) {
					...
					return (
						B &&
							...
							(s = r.width / a),
							(l = r.height / a)),
						x.autoA11y && !n && (o.attributes['aria-hidden'] = 'true'),
						Promise.resolve([
							t,
							le({
								content: t.innerHTML,
		...
		We = b(
			b(
				b(b({}, { FontAwesome: { normal: 'fas', 400: 'fas' } }), {
		...
		He = Object.keys(We).reduce((t, e) => ((t[e.toLowerCase()] = We[e]), t), {}),
		_e = Object.keys(He).reduce((t, e) => {
			var a = He[e];
			return (t[e] = a[900] || [...Object.entries(a)][0][1]), t;
		}, {});
	function Ue(m, h) {
		let p = ''.concat(rt).concat(h.replace(':', '-'));
		return new Promise((s, a) => {
			if (null !== m.getAttribute(p)) return s();
			var r,
				n,
				l = w(m.children).filter((t) => t.getAttribute(at) === h)[0],
			...
			if (u && 'none' !== t && '' !== t) {
				...
				(n = t),
					...
					(f =
						(d =
							55296 <= (f = r.charCodeAt(n)) &&
							f <= 56319 &&
							n + 1 < d &&
							56320 <= (d = r.charCodeAt(n + 1)) &&
							d <= 57343
								? 1024 * (f - 55296) + d - 56320 + 65536
								: f) >= Ye[0] && d <= Ye[1]);
				var { value: c, isSecondary: f } = {
				...
				if (
					(d &&
						...
						(c = u ||
							...
							.iconName) &&
						c.prefix &&
						((e = c.iconName), (i = c.prefix)),
					!e || f || (l && l.getAttribute(nt) === i && l.getAttribute(it) === o))
				)
					s();
				else {
	...
	function qe(n) {
		if (f)
			return new Promise((t, e) => {
				...
				let r = pe.begin('searchPseudoElements');
				Ae(),
					Promise.all(a)
						.then(() => {
							r(), Pe(), t();
	...
	let Ve = {
			...
			hooks() {
				return {
					...
					watch(t) {
						...
						Ge ? Pe() : Ne(ae('mutationObserverCallbacks', { observeMutationsRoot: e }));
					}
				};
			}
		},
		...
		Qe = {
			...
			provides(t) {
				t.generateAbstractTransformGrouping = function (t) {
					var { main: e, transform: a, containerWidth: r, iconWidth: n } = t,
						r = { transform: 'translate('.concat(r / 2, ' 256)') },
						...
						r = {
							outer: r,
							inner: { transform: ''.concat(i, ' ').concat(o, ' ').concat(a) },
		...
		Ze = { x: 0, y: 0, width: '100%', height: '100%' };
	function $e(t) {
		return (
			t.attributes &&
		...
		Qe,
		{
				...
				return {
					parseNodeAttributes(t, e) {
						var a = e.getAttribute('data-fa-mask'),
							a = a ? Qt(a.split(' ').map((t) => t.trim())) : Gt();
						return (
							a.prefix || (a.prefix = S),
							(t.mask = a),
			...
			provides(t) {
				t.generateAbstractMask = function (t) {
					var { children: e, attributes: a, main: r, mask: n, maskId: i, transform: o } = t,
						{ width: r, icon: s } = r,
						{ width: n, icon: l } = n,
						o = ((t) => {
							var { transform: e, containerWidth: a, iconWidth: r } = t,
							...
							return {
								outer: a,
								inner: { transform: ''.concat(n, ' ').concat(i, ' ').concat(e) },
								path: { transform: 'translate('.concat((r / 2) * -1, ' -256)') }
							};
						})({ transform: o, containerWidth: n, iconWidth: r }),
						n = { tag: 'rect', attributes: b(b({}, Ze), {}, { fill: 'white' }) },
						r = s.children ? { children: s.children.map($e) } : {},
						s = {
							tag: 'g',
							attributes: b({}, o.inner),
							children: [$e(b({ tag: s.tag, attributes: b(b({}, s.attributes), o.path) }, r))]
						},
						r = { tag: 'g', attributes: b({}, o.outer), children: [s] },
						o = 'mask-'.concat(i || k()),
						s = 'clip-'.concat(i || k()),
						i = {
							tag: 'mask',
							attributes: b(
								b({}, Ze),
								{},
								{ id: o, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }
							),
							children: [n, r]
						},
						n = {
					...
					(t.missingIconAbstract = function () {
						var t = [],
							...
							r =
								...
								b(b({}, a), {}, { attributeName: 'opacity' })),
							n = {
								tag: 'circle',
								attributes: b(b({}, e), {}, { cx: '256', cy: '364', r: '28' }),
								children: []
							};
						return (
							i ||
								n.children.push(
									...
									{ tag: 'animate', attributes: b(b({}, r), {}, { values: '1;0;1;1;0;1;' }) }
								),
							t.push(n),
							t.push({
								tag: 'path',
								...
								children: i
									? []
									: [{ tag: 'animate', attributes: b(b({}, r), {}, { values: '1;0;0;0;0;1;' }) }]
							}),
							i ||
								t.push({
									tag: 'path',
									...
									children: [
										{ tag: 'animate', attributes: b(b({}, r), {}, { values: '0;0;1;1;0;0;' }) }
									]
								}),
	...
	!(function (t) {
		...
		U &&
			(e.FontAwesome || (e.FontAwesome = ie),
			Mt(() => {
				F(), z('bootstrap');
			})),
			(P.hooks = b(
