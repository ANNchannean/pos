...
(() => {
	...
	a.document,
		z.documentElement && z.head && 'function' == typeof z.addEventListener && z.createElement,
	...
	var o = f({}, z);
	(o[M] = f(f(f(f({}, { 'fa-duotone': 'duotone' }), z[M]), s), r)),
		C(o),
		((z = f(
			{},
			{
	...
	function h(c, l, s) {
		var { skipHooks: a = !1 } = 2 < arguments.length && void 0 !== s ? s : {},
			z = u(l);
		'function' != typeof d.hooks.addPack || a
			? (d.styles[c] = f(f({}, d.styles[c] || {}), z))
			: d.hooks.addPack(c, u(l)),
			'fas' === c && h('fa', l);
	}
	var g = {
		'trash-can': [
	...
	!(function (c) {
		try {
			for (var l = arguments.length, s = new Array(1 < l ? l - 1 : 0), a = 1; a < l; a++)
				s[a - 1] = arguments[a];
			c(...s);
		} catch (c) {
			if (!n) throw c;
