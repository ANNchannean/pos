...
((t) => {
	...
	i &&
		!(u = (d.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(d.readyState)) &&
	...
	(function (t) {
		...
		function f(t, e) {
			...
			for (
				var n, o, r, a, i = 1732584193, s = -271733879, f = -1732584194, c = 271733878, l = 0;
				l < t.length;
				l += 16
			)
				(i = u((n = i), (o = s), (r = f), (a = c), t[l], 7, -680876936)),
					(c = u(c, i, s, f, t[l + 1], 12, -389564586)),
					(f = u(f, c, i, s, t[l + 2], 17, 606105819)),
					(s = u(s, f, c, i, t[l + 3], 22, -1044525330)),
					(i = u(i, s, f, c, t[l + 4], 7, -176418897)),
					(c = u(c, i, s, f, t[l + 5], 12, 1200080426)),
					(f = u(f, c, i, s, t[l + 6], 17, -1473231341)),
					(s = u(s, f, c, i, t[l + 7], 22, -45705983)),
					(i = u(i, s, f, c, t[l + 8], 7, 1770035416)),
					(c = u(c, i, s, f, t[l + 9], 12, -1958414417)),
					(f = u(f, c, i, s, t[l + 10], 17, -42063)),
					(s = u(s, f, c, i, t[l + 11], 22, -1990404162)),
					(i = u(i, s, f, c, t[l + 12], 7, 1804603682)),
					(c = u(c, i, s, f, t[l + 13], 12, -40341101)),
					(f = u(f, c, i, s, t[l + 14], 17, -1502002290)),
					(i = h(i, (s = u(s, f, c, i, t[l + 15], 22, 1236535329)), f, c, t[l + 1], 5, -165796510)),
					(c = h(c, i, s, f, t[l + 6], 9, -1069501632)),
					(f = h(f, c, i, s, t[l + 11], 14, 643717713)),
					(s = h(s, f, c, i, t[l], 20, -373897302)),
					(i = h(i, s, f, c, t[l + 5], 5, -701558691)),
					(c = h(c, i, s, f, t[l + 10], 9, 38016083)),
					(f = h(f, c, i, s, t[l + 15], 14, -660478335)),
					(s = h(s, f, c, i, t[l + 4], 20, -405537848)),
					(i = h(i, s, f, c, t[l + 9], 5, 568446438)),
					(c = h(c, i, s, f, t[l + 14], 9, -1019803690)),
					(f = h(f, c, i, s, t[l + 3], 14, -187363961)),
					(s = h(s, f, c, i, t[l + 8], 20, 1163531501)),
					(i = h(i, s, f, c, t[l + 13], 5, -1444681467)),
					(c = h(c, i, s, f, t[l + 2], 9, -51403784)),
					(f = h(f, c, i, s, t[l + 7], 14, 1735328473)),
					(i = g(i, (s = h(s, f, c, i, t[l + 12], 20, -1926607734)), f, c, t[l + 5], 4, -378558)),
					(c = g(c, i, s, f, t[l + 8], 11, -2022574463)),
					(f = g(f, c, i, s, t[l + 11], 16, 1839030562)),
					(s = g(s, f, c, i, t[l + 14], 23, -35309556)),
					(i = g(i, s, f, c, t[l + 1], 4, -1530992060)),
					(c = g(c, i, s, f, t[l + 4], 11, 1272893353)),
					(f = g(f, c, i, s, t[l + 7], 16, -155497632)),
					(s = g(s, f, c, i, t[l + 10], 23, -1094730640)),
					(i = g(i, s, f, c, t[l + 13], 4, 681279174)),
					(c = g(c, i, s, f, t[l], 11, -358537222)),
					(f = g(f, c, i, s, t[l + 3], 16, -722521979)),
					(s = g(s, f, c, i, t[l + 6], 23, 76029189)),
					(i = g(i, s, f, c, t[l + 9], 4, -640364487)),
					(c = g(c, i, s, f, t[l + 12], 11, -421815835)),
					(f = g(f, c, i, s, t[l + 15], 16, 530742520)),
					(i = m(i, (s = g(s, f, c, i, t[l + 2], 23, -995338651)), f, c, t[l], 6, -198630844)),
					(c = m(c, i, s, f, t[l + 7], 10, 1126891415)),
					(f = m(f, c, i, s, t[l + 14], 15, -1416354905)),
					(s = m(s, f, c, i, t[l + 5], 21, -57434055)),
					(i = m(i, s, f, c, t[l + 12], 6, 1700485571)),
					(c = m(c, i, s, f, t[l + 3], 10, -1894986606)),
					(f = m(f, c, i, s, t[l + 10], 15, -1051523)),
					(s = m(s, f, c, i, t[l + 1], 21, -2054922799)),
					(i = m(i, s, f, c, t[l + 8], 6, 1873313359)),
					(c = m(c, i, s, f, t[l + 15], 10, -30611744)),
					(f = m(f, c, i, s, t[l + 6], 15, -1560198380)),
					(s = m(s, f, c, i, t[l + 13], 21, 1309151649)),
					(i = m(i, s, f, c, t[l + 4], 6, -145523070)),
					(c = m(c, i, s, f, t[l + 11], 10, -1120210379)),
					(f = m(f, c, i, s, t[l + 2], 15, 718787259)),
					(s = m(s, f, c, i, t[l + 9], 21, -343485551)),
					(i = d(i, n)),
					(s = d(s, o)),
					(f = d(f, r)),
					(c = d(c, a));
		...
		function a(t, e) {
			var n,
				...
				a = [],
				i = [];
			for (a[15] = i[15] = void 0, 16 < r.length && (r = f(r, 8 * t.length)), n = 0; n < 16; n += 1)
				(a[n] = 909522486 ^ r[n]), (i[n] = 1549556828 ^ r[n]);
	...
	let w = 'fa-kits-diag',
		...
		v = 'data-md5',
		A = 'data-fa-detection-ignore',
		x = 'data-fa-detection-timeout',
	...
	function O(t) {
		var { nodesTested: e, nodesFound: n } = t;
	...
	function C(t) {
		...
		var o = ((e) => {
				var o = Array.from(d.scripts).filter((t) => !t.hasAttribute(A) && t !== e),
					r = {};
				for (let s = 0; s < o.length; s++) {
					let t = d.createElement('iframe'),
						e = (t.setAttribute('style', 'display:none;'), d.createElement('script'));
					e.setAttribute('id', y);
					var a = p(o[s]);
					e.setAttribute(v, a),
						(r[a] = o[s]),
						'' !== o[s].src && (e.src = o[s].src),
						'' !== o[s].innerText && (e.innerText = o[s].innerText),
						(e.async = !0);
			...
			r = (() => {
				var t = Array.from(d.getElementsByTagName('link')).filter((t) => !t.hasAttribute(A)),
					e = Array.from(d.getElementsByTagName('style')).filter(
						(t) =>
							!(
								t.hasAttribute(A) ||
								(l.FontAwesomeConfig &&
				...
				for (let f = 0; f < t.length; f++) {
					var r = d.createElement('link'),
						a =
							(r.setAttribute('id', y),
							r.setAttribute('href', t[f].href),
							r.setAttribute('rel', t[f].rel),
							p(t[f]));
					r.setAttribute(v, a), (o[a] = t[f]), n(r, a);
				}
				for (let c = 0; c < e.length; c++) {
					var i = d.createElement('style'),
						s = (i.setAttribute('id', y), p(e[c]));
					i.setAttribute(v, s), (i.innerText = e[c].innerText), (o[s] = e[c]), n(i, s);
				}
				return o;
			})();
		let a = s(s({}, o), r),
			i = Object.keys(o).length + Object.keys(r).length;
	...
	var n = l.FontAwesomeDetection || {},
		n = s(
					...
					{},
					{
						report: function (t) {
							...
							if (0 < (a = Object.keys(n.noConflict).length)) {
								console.info(
									'%cNo conflict'
										.concat(1 < a ? 's' : '', ' found with ')
										.concat(1 === a ? 'this' : 'these', ':'),
							...
							if (0 < (a = Object.keys(r).length)) {
								...
								for (u in r) {
									...
									h[u] = {
										...
										'innerText excerpt':
											g.innerText && '' !== g.innerText
												? g.innerText.slice(0, 200) + '...'
												: '(empty)'
									};
								}
								console.table(h);
			...
			{},
			{ __pollUntil: E, md5ForNode: p, detectionDone: !1, nodesTested: null, nodesFound: null }
		),
		n =
		...
		F = 'classic',
		k = { fak: 'kit', 'fa-kit': 'kit' },
		j = { fakd: 'kit-duotone', 'fa-kit-duotone': 'kit-duotone' },
		N = { kit: 'fak' },
		P = { 'kit-duotone': 'fakd' };
	let S = (() => {
		try {
	...
	var I = s({}, n),
		n =
			((I[F] = s(s(s(s({}, { 'fa-duotone': 'duotone' }), n[F]), k), j)),
			M(I),
			s(
				{},
				{
		...
		k =
			((n[F] = s(s(s(s({}, { duotone: 'fad' }), n[F]), N), P)),
			M(n),
			s(
				{},
				{
