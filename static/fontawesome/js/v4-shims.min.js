...
((a, l) => {
	...
	function n(a, l, e) {
		...
		(l =
			...
			typeof (r = ((a, l) => {
				...
				? r
				: r + '') in a
			? Object.defineProperty(a, l, { value: e, enumerable: !0, configurable: !0, writable: !0 })
			: (a[l] = e);
	}
	function o(l, a) {
		var e,
		...
		return (
			Object.getOwnPropertySymbols &&
				((e = Object.getOwnPropertySymbols(l)),
				a &&
	...
	var f = {
		...
		u = { fakd: 'kit-duotone', 'fa-kit-duotone': 'kit-duotone' },
		i = { kit: 'fak' },
		b = { 'kit-duotone': 'fakd' },
	...
	var h = t({}, f),
		f =
			((h[s] = t(t(t(t({}, { 'fa-duotone': 'duotone' }), f[s]), e), u)),
			p(h),
			t(
				{},
				{
		...
		e =
			((f[s] = t(t(t(t({}, { duotone: 'fad' }), f[s]), i), b)),
			p(f),
			t(
				{},
				{
