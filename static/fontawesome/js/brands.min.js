...
(() => {
	...
	var r = C({}, a);
	(r[v] = C(C(C(C({}, { 'fa-duotone': 'duotone' }), a[v]), z), M)),
		f(r),
		((a = C(
			{},
			{
	...
	function i(c, l, z) {
		var { skipHooks: h = !1 } = 2 < arguments.length && void 0 !== z ? z : {},
			a = o(l);
		'function' != typeof t.hooks.addPack || h
			? (t.styles[c] = C(C({}, t.styles[c] || {}), a))
			: t.hooks.addPack(c, o(l)),
			'fas' === c && i('fa', l);
	}
	var d = {
		monero: [
